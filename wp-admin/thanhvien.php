...
$title = __ ( 'THÀNH VIÊN' );
$parent_file = 'thannhvien.php';

add_screen_option ( 'per_page', array (
		'label' => _x ( 'Thành viên', 'users per page (screen options)' ) 
) );
...
get_current_screen ()->set_help_sidebar ( '<p><strong>' . __ ( 'For more information:' ) . '</strong></p>' . '<p>' . __ ( '<a href="http://codex.wordpress.org/Users_Screen" target="_blank">Documentation on Managing Users</a>' ) . '</p>' . '<p>' . __ ( '<a href="http://codex.wordpress.org/Roles_and_Capabilities" target="_blank">Descriptions of Roles and Capabilities</a>' ) . '</p>' . '<p>' . __ ( '<a href="https://wordpress.org/support/" target="_blank">Support Forums</a>' ) . '</p>' );
...
<div class="error">
			<p>
				<strong><?php _e( 'ERROR:' ); ?></strong> <?php _e( 'Please select an option.' ); ?></p>
		</div>
<?php endif; ?>
	...
	<fieldset>
			...
			<ul style="list-style: none;">
				<li><label><input type="radio" id="delete_option0"
						name="delete_option" value="delete" />
...
echo '<label for="delete_option1">' . __ ( 'Attribute all content to:' ) . '</label> ';
			wp_dropdown_users ( array (
					'name' => 'reassign_user',
					'exclude' => array_diff ( $userids, array (
							$current_user->ID 
					) ) 
			) );
			?></li>
...
<p class="search-box">
			...
			<input type="date" id="user-search-input" name="todate" value=""> 
			<input type="date" id="user-search-input" name="fromdate" value="">
...
<span class="pagination-links"><a class="first-page disabled" title="Go to the first page" href="http://localhost/wordpress/wp-admin/thanhvien.php">«</a>
<a class="prev-page disabled" title="Go to the previous page" href="http://localhost/wordpress/wp-admin/thanhvien.php?paged=1">‹</a>
...
<a class="next-page disabled" title="Go to the next page" href="http://localhost/wordpress/wp-admin/thanhvien.php?paged=1">›</a>
<a class="last-page disabled" title="Go to the last page" href="http://localhost/wordpress/wp-admin/thanhvien.php?paged=1">»</a></span></div>
		<br class="clear">
	</div>
<?php
		$to_date = $_GET['todate'];
		...
		{
			$sql = "SELECT * FROM wp_users where user_registered > '$to_date' AND user_registered < '$from_date'";
		} else {
...
<table class="wp-list-table widefat fixed users">
			<thead>
				<tr>
					<th scope="col" id="cb"
						class="manage-column column-cb check-column" style=""><label
					...
					<th scope="col" id="username"
						class="manage-column column-username sortable desc" style=""><a
						href="<?php the_permalink(); ?>"><span>Tên
								đăng nhập</span><span class="sorting-indicator"></span></a></th>
					<th scope="col" id="name"
						class="manage-column column-name sortable desc" style=""><a
						href="http://localhost/wordpress/wp-admin/thanhvien.php?orderby=name&amp;order=asc"><span>Tên</span><span
							class="sorting-indicator"></span></a></th>
					<th scope="col" id="email"
						class="manage-column column-email sortable desc" style=""><a
						href="http://localhost/wordpress/wp-admin/thanhvien.php?orderby=email&amp;order=asc"><span>E-mail</span><span
							class="sorting-indicator"></span></a></th>
					<th scope="col" id="role" class="manage-column column-role"
						style="">Quyền</th>
					<th scope="col" id="posts" class="manage-column column-posts num"
						style="">Bài Post</th>
				</tr>
			</thead>
			...
			<tfoot>
				<tr>
					...
					<th scope="col" class="manage-column column-username sortable desc"
						style=""><a
						href="http://localhost/wordpress/wp-admin/thanhvien.php?orderby=login&amp;order=asc"><span>Tên
								đăng nhập</span><span class="sorting-indicator"></span></a></th>
					...
					<th scope="col" class="manage-column column-email sortable desc"
						...
						href="http://localhost/wordpress/wp-admin/thanhvien.php?orderby=email&amp;order=asc"><span>E-mail</span><span
							class="sorting-indicator"></span></a></th>
					<th scope="col" class="manage-column column-role" style="">Quyền</th>
					<th scope="col" class="manage-column column-posts num" style="">Bài
						Post</th>
				</tr>
			</tfoot>
			<?php count($user_query) ?>
			<tbody id="the-list" data-wp-lists="list:user">
			<?php if (count($user_query) > 0) : foreach($user_query as $set_user) :?>
				<tr id="user-1" class="alternate">
					<th scope="row" class="check-column"><label
						class="screen-reader-text" for="cb-select-1">Select admin</label><input
						type="checkbox" name="users[]" id="user_1" class="administrator"
						value="1"></th>
					<td class="username column-username"><img alt=""
						src="http://0.gravatar.com/avatar/22e1f998f2a82bc85380534b101b7a44?s=32&amp;d=http%3A%2F%2F0.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D32&amp;r=G"
						class="avatar avatar-32 photo" height="32" width="32"> <strong><a
							href="http://localhost/wordpress/wp-admin/profile.php?wp_http_referer=%2Fwordpress%2Fwp-admin%2Fthanhvien.php"><?php echo $set_user->user_nicename ?></a></strong><br>
					<div class="row-actions">
							<span class="edit"><a
								href="http://localhost/wordpress/wp-admin/profile.php?wp_http_referer=%2Fwordpress%2Fwp-admin%2Fthanhvien.php">Edit</a></span>
						</div></td>
					<td class="name column-name"></td>
					<td class="email column-email"><a href="mailto:<?php echo $set_user->user_email ?>"
						title="E-mail: <?php echo $set_user->user_email ?>"><?php echo $set_user->user_email ?></a></td>
					<td class="role column-role"><?php echo $set_user->user_email ?></td>
					<td class="posts column-posts num"><a href="edit.php?author=1"
						title="View posts by this author" class="edit">2</a></td>
				</tr>
				
			<?php endforeach; else : ?>
			<tr class="no-items"><td class="colspanchange" colspan="6">No matching users were found.</td></tr>
			<?php endif; ?>
			</tbody>
		</table>
	</form>
